...
interface LoginFormProps {
    ...
    userType: 'agent' | 'guest';
    isLoading: boolean;
    error: string | null;
}

export default function LoginForm({ onSubmit, userType, isLoading, error }: LoginFormProps) {
            ...
            <div className="max-w-md w-full">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">
                        {userType === 'agent' ? 'Agent Login' : 'Guest Portal Login'}
                    </h1>
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-gray-600">
                            {userType === 'agent' ? (
                                <>
                                    Are you a guest?{' '}
                                    <a href="/login/guest" className="text-blue-600 hover:text-blue-700 font-semibold">
                                        Guest Login
                                    </a>
                                </>
                            ) : (
                                <>
                                    Are you an agent?{' '}
                                    <a href="/login/agent" className="text-blue-600 hover:text-blue-700 font-semibold">
                                        Agent Login
                                    </a>
                                </>
                            )}
