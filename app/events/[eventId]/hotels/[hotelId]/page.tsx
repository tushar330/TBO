...
export default function HotelDetailsPage() {
  ...
  const BANQUET_HALLS = [
    ...
    },
    {
      ...
      name: "Crystal Hall",
      capacity: 300,
      facilities: ["AC", "Projector", "Audio System", "LED Screen"],
      pricePerSlot: 35000,
    },
    {
      id: "garden-pavilion",
      ...
      capacity: 200,
      facilities: ["Open Air", "Stage", "Audio System", "Lighting"],
      pricePerSlot: 25000,
    },
    {
      id: "conference-hall",
      ...
      capacity: 150,
      facilities: ["AC", "Projector", "Whiteboard", "Audio System"],
      pricePerSlot: 20000,
    },
  ];
  ...
  const MEAL_PLANS = [
    {
      id: "breakfast",
      name: "Breakfast",
      description: "Continental & Indian breakfast spread",
      menuHighlights: [
        "Fresh Fruits",
        "Pastries",
        "Indian Breakfast",
    ...
    },
    {
      id: "dinner",
      name: "Dinner Buffet",
      description: "Premium dinner buffet",
      menuHighlights: [
        "Welcome Drinks",
        "Starters",
        "Main Course (5 items)",
    ...
    },
    {
      ...
      menuHighlights: ["Snacks", "Sandwiches", "Pastries", "Tea/Coffee"],
      pricePerPerson: 400,
    },
    {
      id: "full-day",
      name: "Full Day Package",
      description: "Breakfast, lunch, hi-tea, and dinner",
      menuHighlights: [
        "All Meals Included",
        "Unlimited Beverages",
        "Premium Menu",
  ...
  const getBanquetCost = () => {
    ...
    const hall = BANQUET_HALLS.find((h) => h.id === selectedBanquetHall);
    return hall ? hall.pricePerSlot : 0;
  };

  const getCateringCost = () => {
    if (!selectedMealPlan) return 0;
    const plan = MEAL_PLANS.find((p) => p.id === selectedMealPlan);
    return plan ? plan.pricePerPerson * attendeeCount : 0;
  };
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex items-start gap-3 flex-1">
                              <input
                                ...
                                onChange={() => setSelectedBanquetHall(hall.id)}
                            ...
                            <div className="text-right ml-4">
                              ...
                              >
                                ₹{hall.pricePerSlot.toLocaleString()}
                              </div>
                      ...
                      {attendeeCount > 0 && selectedBanquetHall && (
                        <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                          <p className="text-sm text-amber-800">
                            <strong>Note:</strong> Selected hall capacity should
                            accommodate {attendeeCount} attendees.
                            {(() => {
                              const hall = BANQUET_HALLS.find(
                              ...
                              {selectedMealPlan === plan.id &&
                                attendeeCount > 0 && (
                                  <div className="text-sm font-medium text-emerald-700 mt-1">
                                    Total: ₹
                                    {(
                                      plan.pricePerPerson * attendeeCount
                                    ).toLocaleString()}
                                  </div>
                                )}
                            </div>
                  ...
                  !selectedMealPlan ? (
                    ...
                    <>
                      ...
                      {Object.keys(hotel.rooms).map((catKey) => {
                        ...
                        const catRooms = (
                          hotel.rooms[
                            catKey as keyof typeof hotel.rooms
                          ] as RoomType[]
                          ...
                          >
                            <span className="text-neutral-600">
                              ...
                              <span className="text-neutral-400">
                                x{selectedRooms[room.id]}
                              </span>
                            </span>
                            <span className="font-medium text-neutral-900">
                              ₹
                              {(
                                room.price * selectedRooms[room.id]
                              ).toLocaleString()}
                            </span>
                          </div>
                        ));
